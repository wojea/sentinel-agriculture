...
if __name__ == '__main__':
    ...
    footprint = geojson_to_wkt(read_geojson('geojson/geojson.geojson'))
    ...
    with ZipFile(f'{products[next(iter(products))]["title"]}.zip', 'r') as satelite_zip:
        ...
        allowed_formats = ['B04_10m.jp2', 'B08_10m.jp2', 'B8A_20m.jp2', 'B11_20m.jp2']
        filtered_files = list()
        ...
        #print(opened_files)
        image = Image.open(next(iter(opened_files)))
